...
void sendDataToOpenGL()
{
	...
	const GLfloat snowPointsColour1[] =
	{
		1.0f, 1.0f, 1.0f,
		1.0f, 1.0f, 1.0f,
		1.0f, 1.0f, 1.0f,
	...
	const GLfloat snowPointsColour2[] =
	{
		0.8f, 0.8f, 0.8f,
		0.8f, 0.8f, 0.8f,
		0.8f, 0.8f, 0.8f,
	...
	const GLfloat snowPointsColour3[] =
	{
		0.6f, 0.6f, 0.6f,
		0.6f, 0.6f, 0.6f,
		0.6f, 0.6f, 0.6f,
	...
	const GLfloat snowPointsColour4[] =
	{
		0.4f, 0.4f, 0.4f,
		0.4f, 0.4f, 0.4f,
		0.4f, 0.4f, 0.4f,
	...
	const GLfloat snowPointsColour5[] =
	{
		0.2f, 0.2f, 0.2f,
		0.2f, 0.2f, 0.2f,
		0.2f, 0.2f, 0.2f,
	...
	// changing snow colour
	if (changeColour == 0)
	{
		glGenBuffers(1, &vboSnowPointsColour[0]);
		glBindBuffer(GL_ARRAY_BUFFER, vboSnowPointsColour[0]);
		glBufferData(GL_ARRAY_BUFFER, sizeof(snowPointsColour1), snowPointsColour1, GL_STATIC_DRAW);
		glEnableVertexAttribArray(1);
		glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 0, 0);
	}
	else if (changeColour == 1)
	{
		glGenBuffers(1, &vboSnowPointsColour[1]);
		glBindBuffer(GL_ARRAY_BUFFER, vboSnowPointsColour[1]);
		glBufferData(GL_ARRAY_BUFFER, sizeof(snowPointsColour2), snowPointsColour2, GL_STATIC_DRAW);
		glEnableVertexAttribArray(1);
		glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 0, 0);
	}
	else if (changeColour == 2)
	{
		glGenBuffers(1, &vboSnowPointsColour[2]);
		glBindBuffer(GL_ARRAY_BUFFER, vboSnowPointsColour[2]);
		glBufferData(GL_ARRAY_BUFFER, sizeof(snowPointsColour3), snowPointsColour3, GL_STATIC_DRAW);
		glEnableVertexAttribArray(1);
		glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 0, 0);
	}
	else if (changeColour == 3)
	{
		glGenBuffers(1, &vboSnowPointsColour[3]);
		glBindBuffer(GL_ARRAY_BUFFER, vboSnowPointsColour[3]);
		glBufferData(GL_ARRAY_BUFFER, sizeof(snowPointsColour4), snowPointsColour4, GL_STATIC_DRAW);
		glEnableVertexAttribArray(1);
		glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 0, 0);
	}
	else if (changeColour == 4)
	{
		glGenBuffers(1, &vboSnowPointsColour[4]);
		glBindBuffer(GL_ARRAY_BUFFER, vboSnowPointsColour[4]);
		glBufferData(GL_ARRAY_BUFFER, sizeof(snowPointsColour5), snowPointsColour5, GL_STATIC_DRAW);
		glEnableVertexAttribArray(1);
		glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 0, 0);
	}
